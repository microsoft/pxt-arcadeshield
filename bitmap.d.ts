interface Bitmap {
    ...
    //% help=github:pxt-arcadeshield/docs/fill
    ...
    //% help=github:pxt-arcadeshield/docs/set-pixel
    //% this.shadow="theScreen"
    //% weight=96
    ...
    //% help=github:pxt-arcadeshield/docs/get-pixel
    //% this.shadow="theScreen"
    //% weight=92
    ...
    //% help=github:pxt-arcadeshield/docs/draw-line
    //% this.shadow="theScreen"
    //% weight=88
    ...
    //% help=github:pxt-arcadeshield/docs/draw-rect
    //% this.shadow="theScreen"
    //% weight=84
    ...
    //% help=github:pxt-arcadeshield/docs/fill-rect
    //% this.shadow="theScreen"
    //% weight=80
    ...
    //% help=github:pxt-arcadeshield/docs/draw-bitmap
    //% this.shadow="theScreen"
    //% this.defl=bitmap
    ...
    //% help=github:pxt-arcadeshield/docs/draw-bitmap-transparent
    //% this.shadow="theScreen"
    //% this.defl=bitmap
    //% from.shadow=variables_get
    //% from.defl="bitmap"
    ...
    //% blockId=bitmapFlipX
    //% help=github:pxt-arcadeshield/docs/flip-x
    //% this.shadow="theScreen"
    //% weight=72
    flipX(): void;
    ...
    //% blockId=bitmapFlipY
    //% help=github:pxt-arcadeshield/docs/flip-y
    //% this.shadow="theScreen"
    //% weight=68
    flipY(): void;
    ...
    //% help=github:pxt-arcadeshield/docs/scroll
    //% this.shadow="theScreen"
    ...
    //% help=github:pxt-arcadeshield/docs/replace
    //% this.shadow="theScreen"
    //% weight=60 
    ...
    //% this.defl="bitmap"
    //% other.defl="bitmap2"
    //% help=github:pxt-arcadeshield/docs/equals
    ...
    //% block="clone $this"
    //% blockId=bitmapClone
    //% help=github:pxt-arcadeshield/docs/clone
    //% this.shadow=variables_get
    //% this.defl="bitmap"
    clone(): Bitmap;
}
